...
const { validaPedido, validaIdParams, validaProdutosComandaPedido } = require("../middleware/validacao.middleware");
...
router.post("/create", authMiddleware, validaProdutosComandaPedido,validaPedido, pedidoController.createPedidoController);
